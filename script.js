// function to clear content from screen before displaying another piece of content
function clearAll() {
...
function showMeme() {
	...
	const randMemeURL = memes[randIndex];
	const container = document.querySelector('.meme-content');
	const newImage = document.createElement('img');
	newImage.setAttribute('src', randMemeURL);
	clearAll();
...
function showQuote() {
	...
	const randQuote = quotes[randIndex].quote;
	const randAuthor = quotes[randIndex].author;
	const container = document.querySelector('.quote-content');
	const quoteP = document.createElement('p');
	const authorP = document.createElement('p');
	quoteP.textContent = randQuote;
	authorP.textContent = "-" + randAuthor;
	clearAll();
...
function showAnswer() {
	...
	if(answer) {
		...
		console.log("There is no riddle answer because there is no riddle goofy");
	}
}
...
const memes = [
	...
	'https://i.redd.it/iij16swxjie61.jpg', 'https://i.redd.it/vek7dm2hrge61.jpg', 
